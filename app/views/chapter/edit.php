	...
	<form action="<?php L(array('action' => 'edit', 'id' => $chapter->id)) ?>" method="POST">
		<fieldset class="chapter-details">
			...
			<div class="fields">
				<table class="form-table">
					...
					<tr>
						<td class="label"><?php $form->label('twitter_username', 'Twitter @username')?></td>
		...
		<fieldset class="contacts">
			...
			<div class="fields">
				<table class="form-table">
					<tr>
						<td class="label"><?php $form->label('contact_person_name', 'Nama Contact Person')?></td>
		...
		<fieldset class="depots">
			<legend>Pengumpulan Berkas</legend>
			<div class="fields">
				<table class="form-table">
					<tr>
						<td class="field"><?php $form->checkbox('use_verification_deadline'); echo ' '; $form->label('use_verification_deadline', 'Berkas harus dikumpulkan sesuai dengan batas pendaftaran')?>
					<tr>
						<td class="field"><?php $form->label('depots_yaml', 'Lokasi & Jadwal Pengumpulan Berkas')?><br><?php $form->textarea('depots_yaml', 'large yaml') ?> <span class="instruction">Informasi pengumpulan berkas dalam YAML (hubungi Kak Gichie untuk petunjuk lebih lanjut).</span><br><a href="<?php L(array('controller' => 'applicant', 'action' => 'finalized', 'preview' => $chapter->id)) ?>">Lihat tampilan</a> (Simpan terlebih dahulu)</td>
					</tr>
				</table>
			</div>
		</fieldset>
