...
<div class="container">
	<table class="chapters">
		...
		<tr>
			...
			<td class="actions">
				<p class="more"><a href="<?php L(array('controller' => 'applicant', 'action' => 'index', 'chapter_id' => $chapter->id)) ?>"><strong><?php echo $chapter->get_applicant_count() ?></strong> pendaftar</a></p>
				<p class="edit"><a href="<?php L(array('controller' => 'chapter', 'action' => 'edit', 'chapter_id' => $chapter->id)) ?>">Edit informasi</a></p>
			</td>
		</tr>
