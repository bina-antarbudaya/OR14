		...
		<table class="batches">
			...
			<tbody>
				...
				<tr>
					...
					<td class="view"><a href="<?php L(array('action' => 'view', 'batch_id' => $b->id)) ?>">Lihat</a></td>
					<td class="print"><a href="<?php L(array('action' => 'view', 'batch_id' => $b->id, 'format' => 'xlsx')) ?>">Excel</a></td>
				</tr>
				<?php endforeach; ?>
			</tbody>
		</table>
